...
export default function Accueil({setUtilisateur}) {
  return (
    <div className="Accueil">
      <h3 className="logo">Memo</h3>
      <div className="conteneur-boutons-connexion">
        <span className="btn-google" onClick={() => connexion().then(
            objConnexionGoogle => setUtilisateur(objConnexionGoogle.user))}>
